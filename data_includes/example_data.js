...
PennController.Sequence("Welcome", "ParticipantInfo", "Instructions", randomize("Examples"), "beforeTrials",randomize("trials"),"send", "final")
...
PennController.Template(
    PennController.GetTable("list1.csv"),  // load your csv
